      ...
      >
        <div className="bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
          <div className="px-8 pt-8 pb-6 text-center">
            ...
            <p className="text-slate-500 mt-1 text-sm">Digite seu e-mail para receber instruções</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="px-8 pb-8 space-y-5">
            {success ? (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="bg-emerald-50 border border-emerald-200 text-emerald-700 p-4 rounded-lg text-center"
              >
                <p className="font-medium">E-mail enviado com sucesso!</p>
                <p className="text-sm mt-1">Verifique sua caixa de entrada</p>
              </motion.div>
            ) : (
              <>
                <div>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 text-emerald-600 hover:text-emerald-700 font-medium py-2"
            >
